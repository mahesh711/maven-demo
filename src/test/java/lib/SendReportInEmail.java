...
public class SendReportInEmail {
	...
	public static void sendGmailReport() throws IOException {
		...
		try {			
			...
			String strMessage = "Hello All,"+newline+newline+"Attached is the test automation run results report for COD R12 Cloud ERP – Procure To Pay (P2P) Cycle."+newline+newline+"Thanks"+newline+"AST Test Automation Team"; 		
			...
			message.setSubject("Daily Test Automation Run Report : COD R12 Cloud ERP");
